#!/usr/bin/env python3
"""Disassemble BuildingClass::InfiltratedBy at 0x4571E0"""
import struct
import capstone
...
def main():
    OUT_FILE = r"e:\WorkSpace\cncnet\Ra2.Vampire.Extend\disasm_infiltratedby.txt"
    out = []
    ...
    start_va = 0x4571E0
    end_va = 0x457400  # generous range
    ...
    out.append(f"\n{'='*60}")
    out.append(f"BuildingClass::InfiltratedBy (0x{start_va:08X} - 0x{end_va:08X})")
    out.append(f"{'='*60}")
