...
//   4. 0x45723C - BuildingClass::InfiltratedBy     (强制渗透效果标志)
//   + 规划路径推进 / 占用判定 / MegaMission 授权辅助钩子
// ===========================================================================
...
static bool IsSpySelfStealScenario(InfantryClass* pThis, BuildingClass* pBuilding)
{
    ...
    // 单点门控：配置关闭时所有间谍自偷逻辑直接放行原版
    if (!VampireConfig::SelfStealEnabled)
        return false;
